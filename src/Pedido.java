...
public class Pedido implements Comparable<Pedido> {
    ...
    /**
     * Construtor do pedido. Deve criar a lista de itens do pedido, armazenar a
     * data e a forma de pagamento informadas para o pedido. TODO: armazene
     * também o cliente que realizou o pedido.
     */
     ...
     * armazenados no pedido até o momento. Caso o produto já exista no pedido,
     * sua quantidade é atualizada. Caso contrário, um novo item de pedido é
     * criado.
     *
     * @param novo O produto a ser incluído no pedido
     * @param quantidade A quantidade do produto a ser incluída no pedido
     * @return true/false indicando se a inclusão do produto no pedido foi
    ...
    /**
     * Calcula e retorna o valor final do pedido (soma do valor de venda de
     * todos os itens do pedido). Caso a forma de pagamento do pedido seja à
     * vista, aplica o desconto correspondente.
     *
    ...
    /**
     * Representação, em String, do pedido. Contém um cabeçalho com sua data e o
     * número de itens de pedido no pedido. Depois, em cada linha, a descrição
     * de cada item do pedido. Ao final, mostra a forma de pagamento, o
     * percentual de desconto (se for o caso) e o valor a ser pago pelo pedido.
     * Exemplo: ID do pedido: 3600 Data do pedido: 25/08/2025 Cliente do pedido:
     * Samuel Silva Correa Pedido com 2 itens. Itens de pedido no pedido: NOME:
     * Iogurte Válido até: 29/08/2025 QUANTIDADE: 2 PREÇO UNITÁRIO: R$ 8.00
     * NOME: Guardanapos QUANTIDADE: 1 PREÇO UNITÁRIO: R$ 2.75 Pedido pago à
     * vista. Percentual de desconto: 15,00% Valor total do pedido: R$ 15.44
     *
     * @return Uma string contendo dados do pedido conforme especificado
     * (cabeçalho, detalhes, forma de pagamento, percentual de desconto - se for
     * o caso - e valor a pagar)
     */
    @Override
    public String toString() {
        ...
        if (cliente != null) {
            ...
            stringPedido.append("Cliente do pedido: (vazio)\n");
        }
    ...
    @Override
    /**
     * Retorna o código identificador do pedido. É um valor único para cada
     * pedido (== chave).
     *
     ...
     * @return booleano true/false conforme o parâmetro possua o código igual ou
     * não a este pedido.
     */
    @Override

...
public class App {
     ...
     * clientes. Arquivo-texto no formato N (quantidade de clientes) <br/>
     * nome do cliente <br/>
     * Deve haver uma linha para cada um dos clientes. Retorna uma árvore vazia
     * em caso de problemas com o arquivo.
     *
     * @param nomeArquivoDados Nome do arquivo de dados a ser aberto.
    ...
    static AVL<Integer, Cliente> lerClientes(String nomeArquivoDados) {
        ...
        try {
            ...
            int nummeroClientes = Integer.parseInt(arquivo.nextLine());

            clientesCadastrados = new AVL<Integer, Cliente>();

            for (int i = 0; i < nummeroClientes; i++) {
            ...
            quantosClientes = nummeroClientes;
    ...
    private static Lista<Pedido> gerarPedidos(int quantidade) {
        ...
        for (int i = 0; i < quantidade; i++) {
            ...
            while (cliente == null && tentativas < 10 && quantosClientes > 0) {
            ...
            for (int j = 0; j < quantProdutos; j++) {
                int id = sorteio.nextInt(1000) + 10_000;
    ...
    /**
     * Associa, na tabela hash pedidosPorCliente, o pedido informado ao
     * histórico de pedidos do cliente. Caso o cliente ainda não possua um
     * histórico registrado, um novo deve ser criado.
     */
    private static void inserirNaTabelaPedidosDoCliente(Cliente cliente, Pedido pedido) {

        Lista<Pedido> historico = new Lista<>();
     ...
     * correspondente e exibe seu histórico completo de pedidos.
     */
